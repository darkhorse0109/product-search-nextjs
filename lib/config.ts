...
export const env = {
  ...
  CREDITS_PER_MONTH_FOR_FREE_PLAN: process.env.CREDITS_PER_MONTH_FOR_FREE_PLAN || 0,
  CREDITS_PER_MONTH_FOR_PAID_PLAN: process.env.CREDITS_PER_MONTH_FOR_PAID_PLAN || 0,
  CURRENCY_PER_MONTH_FOR_PAID_PLAN: process.env.CURRENCY_PER_MONTH_FOR_PAID_PLAN || 0
}
